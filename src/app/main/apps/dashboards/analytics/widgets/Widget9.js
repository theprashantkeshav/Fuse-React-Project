...
const baseURL = "https://raw.githubusercontent.com/sensahin/data/main/conversiondata.json";
        ...
        <tbody>
          {props.data.rows.map((row, index) => (
            <tr key={row.title}>
              ...
              <td className="text-right">{conversion ? conversion[index]: row.conversion}</td>
            </tr>
          ))}
        </tbody>
      </table>
